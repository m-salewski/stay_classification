...
def get_clusters_xxx(t_arr, x_arr, dist_thresh, time_thresh, verbose=False):
    """
    ...
    * rename `gap_criterion_3` to `gap_criterion` (usw)
    ...
    def check_and_merge_clusters(clusters):
        ...
        if gap_criterion_3(dist_thresh, time_thresh)(t_arr, x_arr,c1,c2):            
...
def get_clusters_xxxx(t_arr, x_arr, dist_thresh, time_thresh, verbose=False):
    """
